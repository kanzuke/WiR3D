...
if(isset($_POST)) {
    ...
    $api_key = "d82e2c127b4ff436851da49ce62fdd69";
    $api_url = "http://api.openweathermap.org/data/2.5/forecast/daily?q=".$user_city.",".$user_country."&appid=".$api_key."&units=metric&lang=fr-FR&cnt=4";
    ...
    $cnt = $json['cnt'];
    $user_city = $json['city']['name'];
   
    for($i=0;$i<$cnt; $i++) {
        $weather[$i]['date'] = $json['list'][$i]['dt'];
        $weather[$i]['temp'] = $json['list'][$i]['temp'];
        $weather[$i]['icon'] = $json['list'][$i]['weather'][0]['icon'];
    }
    
    
    ?>
    <hr>
Url: <a href="<?= $api_url; ?>"><?= $api_url; ?></a><br/>

    Cnt: <?= $cnt; ?><br/>
    <?php
    for($i=0;$i<$cnt; $i++) {
        echo "Date: ".$weather[$i]['date']."<br/>";
        echo "Temperature".$weather[$i]['temp']['day']."<br/>";
    }
}
?>
				...
				<div id="card" class="weater">
					<div class="city-selected">
						<article>
							...
							<div class="info">
								<div class="city"><span>City:</span><?= $user_city; ?></div>
								<div class="night">Night - 22:07 PM</div>

								<div class="temp"><?= $weather[0]['temp']['day']; ?>°</div>
